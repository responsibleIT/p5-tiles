...
function drawCenterVoid() {
  // central black stage-like opening with bright text accent
  noStroke();
  ...
  textStyle(BOLD);
  textSize(24);
  text("EURO", originX - 28, originY - 7);
  text("VISION", originX + 37, originY - 7);

  fill(redColor);
  drawHeart(originX + 8, originY - 10, 23);

  fill(whiteColor);
  textSize(12);
  text("SONG CONTEST", originX, originY + 21);

  fill(210);
  textStyle(NORMAL);
  textSize(9);
  text("BASEL 2025", originX, originY + 38);
}
